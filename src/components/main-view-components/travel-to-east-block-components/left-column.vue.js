...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("column travel-to-east-lc") }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.img, __VLS_intrinsicElements.img)({ src: ("../../../assets/travel-to-east-pics/left-column-pic.jpeg"), alt: (""), });
    // @ts-ignore
    [LeftColumnTextBlock,];
    // @ts-ignore
    ...
    if (typeof __VLS_styleScopedClasses === 'object' && !Array.isArray(__VLS_styleScopedClasses)) {
        ...
        __VLS_styleScopedClasses['travel-to-east-lc'];
    }
    var __VLS_slots;
    return __VLS_slots;
